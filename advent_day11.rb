...
test_arr = recursive_flash_method({ point: point, arr: test_arr, flash_sum: test_sum })[1]
test_sum = recursive_flash_method({ point: point, arr: test_arr, flash_sum: test_sum })[0]
point2 = [1,1]
p recursive_flash_method({ point: point2, arr: test_arr, flash_sum: test_sum })
...
#     flash_total = recursive_flash_method({ point: point, arr: arr, flash_sum: flash_total })[0]
#     arr = recursive_flash_method({ point: point, arr: arr, flash_sum: flash_total })[1]
#     arr.each_with_index do |line, index|
#       line.each_with_index do |number, index2|
